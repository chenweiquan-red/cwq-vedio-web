<template>
  <div ref="container" @dblclick="fullscreenSwich"
       style="width:100%;min-height: 250px;background-color: #000000;margin:0 auto;position: relative;">
  ...
  methods: {
    ...
    create() {
      let options = {
        ...
        timeout: 10,
        useMSE: true,
        useWCS: location.hostname === "192.168.10.43" || location.protocol === "https:",
